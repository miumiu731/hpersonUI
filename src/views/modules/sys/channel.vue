    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button v-if="isAuth('sys:channel:update')" type="text" size="small" @click="addOrUpdateHandle(scope.row.chanNo)">修改</el-button>
          <el-button v-if="isAuth('sys:channel:delete')" type="text" size="small" @click="deleteHandle(scope.row.chanNo)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
